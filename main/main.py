...
um programa que leia uma sequencia de comandos e os interprete manipulando a
matriz de acordo com a descrico abaixo de cada comando.

Comandos
--------
I M N
Cria uma nova matriz MxN. Todos os pixels sao brancos (O).
...
K X1 Y1 X2 Y2 C
Desenha um retangulo de cor C. (X1,Y1) e o canto superior esquerdo e (X2,Y2) o
canto inferior direito.

F X Y C
Preenche a regiao com a cor C. A regiao R e definida da seguinte forma:
O pixel (X,Y) pertence a  regiao. Outro pixel pertence a  regiao, se e somente se,
ele tiver a mesma cor que o pixel (X,Y) e tiver pelo menos um lado em comum com
um pixel pertencente a  regiao.
